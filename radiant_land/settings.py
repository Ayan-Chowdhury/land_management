...
AJAX_LOOKUP_CHANNELS = {
    'districts': {'model': 'land_management.District', 'search_field': 'DistrictName'},
    'upazillas': {'model': 'land_management.Upazilla', 'search_field': 'UpazillaName'},
}
runserver.default_port = "18080"